...
export const SAREES: Saree[] = [
  {
    ...
    images: ["/images/bridal.png", "/images/arrival-1.png", "/images/handloom.png", "/images/story.png"],
    size: "tall",
    description:
    ...
    weaveTime: "6–8 weeks",
    care: ["Dry clean only", "Store folded in muslin cloth", "Avoid direct sunlight", "Do not wring or twist"],
  ...
  },
  {
    ...
    images: ["/images/arrival-1.png", "/images/bridal.png", "/images/handloom.png"],
    size: "square",
    description:
    ...
    origin: "Varanasi, Uttar Pradesh",
    weaveTime: "3–4 weeks",
    care: ["Dry clean only", "Air after each wear", "Store in acid-free tissue"],
  ...
  },
  {
    ...
    images: ["/images/festive.png", "/images/arrival-3.png", "/images/handloom.png", "/images/arrival-1.png"],
    size: "tall",
    description:
    ...
    weaveTime: "4–5 weeks",
    care: ["Dry clean only", "Keep away from moisture", "Store separately to avoid color bleed"],
  ...
  },
  {
    ...
    images: ["/images/arrival-2.png", "/images/arrival-4.png", "/images/handloom.png"],
    size: "square",
    description:
    ...
    weaveTime: "2–3 weeks",
    care: ["Gentle hand wash in cold water", "Lay flat to dry", "Iron on low heat with pressing cloth"],
  ...
  },
  {
    ...
    images: ["/images/handloom.png", "/images/story.png", "/images/arrival-1.png"],
    size: "wide",
    description:
    ...
    care: ["Dry clean only", "Store flat, never folded at the same crease", "Air once a year"],
  ...
  },
  {
    ...
    images: ["/images/arrival-3.png", "/images/festive.png", "/images/handloom.png", "/images/bridal.png"],
    size: "tall",
    description:
    ...
    weaveTime: "5–7 weeks",
    care: ["Dry clean only", "Avoid contact with perfume directly", "Store in soft cotton bag"],
  ...
  },
  {
    ...
    images: ["/images/arrival-4.png", "/images/arrival-2.png", "/images/handloom.png"],
    size: "square",
    description:
    ...
    weaveTime: "2 weeks",
    care: ["Hand wash cold, do not rub", "Roll in a towel to remove excess water", "Steam rather than iron"],
  ...
  },
  {
    ...
    images: ["/images/story.png", "/images/handloom.png", "/images/arrival-1.png"],
    size: "tall",
    description:
    ...
    care: ["Hand wash in lukewarm water", "Dry in shade", "Light steam press"],
  ...
  },
  {
    ...
    priceNum: 85000,
    img: "/images/arrival-1.png",
    images: ["/images/arrival-1.png", "/images/bridal.png", "/images/handloom.png", "/images/festive.png"],
    size: "square",
    description:
    ...
    origin: "Varanasi, Uttar Pradesh",
    weaveTime: "10–12 weeks",
    care: ["Professional dry clean only", "Never machine wash", "Store in padded box away from humidity"],
  ...
  },
  {
    ...
    priceNum: 28500,
    img: "/images/arrival-3.png",
    images: ["/images/arrival-3.png", "/images/festive.png", "/images/arrival-1.png"],
    size: "square",
    description:
    ...
    weaveTime: "2–3 weeks",
    care: ["Dry clean only", "Avoid dampness", "Refold along different lines each time"],
  ...
  },
  {
    ...
    priceNum: 35000,
    img: "/images/handloom.png",
    images: ["/images/handloom.png", "/images/story.png", "/images/arrival-3.png"],
    size: "tall",
    description:
    ...
    weaveTime: "4–6 weeks",
    care: ["Hand wash in cold water with mild soap", "Dry flat in shade", "Iron on silk setting from inside"],
  ...
  },
  {
    ...
    priceNum: 21000,
    img: "/images/arrival-4.png",
    images: ["/images/arrival-4.png", "/images/arrival-2.png", "/images/festive.png"],
    size: "square",
    description:
    ...
    origin: "Surat, Gujarat",
    weaveTime: "1–2 weeks",
    care: ["Dry clean recommended", "Handle embellishments with care", "Store flat to preserve drape"],
